 ...
 */
 ...
 func (t *TrackingAsset) storeTracking(stub shim.ChaincodeStubInterface, args []string) peer.Response {
	 ...
	 str := args[1]
	 scanned, err := time.Parse(layout, str)
 
	 // create the new packet object
	 packet := &Packet{commonName, scanned}
 ...
 // ==============================================
 // queryByKey a DataItem from the blockchain
 // ==============================================
 func (t *TrackingAsset) queryByKey(stub shim.ChaincodeStubInterface, args []string) peer.Response {
	 var err error
